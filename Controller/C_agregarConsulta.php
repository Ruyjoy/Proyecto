...
include '/xampp/htdocs/Proyecto/model/M_agregarConsulta.php';

if (isset($_POST['agregarCons'])) {
    ...
    $registro = new M_agregarConsulta();
    $registro->agregarconsulta($nombre, $des, $precio, $ruta);
}
