...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-12-2022 a las 18:12:23
...
--
-- Volcado de datos para la tabla `intentos_usuario`
--

INSERT INTO `intentos_usuario` (`id_usuario`) VALUES
('123');
...
(1, 'Salti', 'Perro', 'Montevideo', 'Se Perdió cercar del Parque Rodó \r\nTeléfono: 099111111', '2022-12-15', '../img/perro 1.jpg', 'Admin', 1),
(2, 'Stella', 'Perro', 'Canelones', 'Si alguien sabe algo por favor me avisa.\r\nTeléfono : 091122222', '2022-12-16', '../img/perro 2.jpg', 'Admin', 1),
(3, 'Thomas', 'Gato', 'Montevideo', 'Se perdió en el Cerritó de la Victoria \r\nTeléfono: 099333333', '2022-12-15', '../img/gato 1.jpg', 'Admin', 1),
(4, 'Gatito', 'Gato', 'San José', 'Se escapo de la casa hace varias horas, cualquier información se agradeces\r\nTeléfono : 094444444', '2022-12-16', '../img/gato 2.jpg', 'Admin', 1),
(5, 'Xula', 'Gato', 'Canalones / Neptunia', 'Se perdió cerca de la Ancap de Neptunia', '2022-12-19', '../img/gato 3.jpg', 'Admin', 1),
(6, 'Tobacoo', 'Perro', 'San José', 'Se me perdió\r\nTeléfono : 098555555 ', '2022-12-17', '../img/perro 3.jpg', 'Admin', 1);
...
('Admin', '$2y$10$lob1hk4hD58vEl024cfuP.GMgkO0up22J2t1QuSqRLuZOnoxyHhpS', 'José Luis', 91777644, 'rivera 2909', 'sss@sss.com', NULL, 2),
...
('Pepe', '$2y$10$x0qE/UBB/QEMHKhCQi95ReK3CDyrQseuwkHD9sqTJXxJhTxGTgsZe', 'Pepe', 9111111, 'rivera 2909', 'xhteamx@gmail.com', NULL, 4),
