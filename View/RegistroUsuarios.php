                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="small mb-1" for="inputLastName">Nombre Usuario / Codigo</label>
                                                    <input class="form-control py-2" name="codigo" type="text" placeholder="Ingrese Nombre Usuario / Codigo" required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2" name="dir" required="required" type="text" placeholder="Ingrese su Direccion" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2" name="pass"  type="password" placeholder="Ingrese una contraseña" required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="small mb-1" for="inputLastName">Repetir Contraseña</label>
                                                    <input class="form-control py-2" name="pass2" type="password" placeholder="Ingrese nuevamente la contraseña" required />
                                                </div>
                                            </div>
