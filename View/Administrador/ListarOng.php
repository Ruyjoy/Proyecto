                    ...
                    <tbody class="align-middle">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="align-middle"><a class="btn btn-sm btn-success" href="EliminarmodificarOng.php?codigo=<?php echo $codigo ?>&pass=<?php echo $pass ?>&nombre=<?php echo $nombre ?>&telefono=<?php echo $telefono ?>&dir=<?php echo $direccion ?>&mail=<?php echo $mail ?>&img=<?php echo $imagen ?>"><i class="fa fa-check"></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
