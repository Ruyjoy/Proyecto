                    ...
                    <form method="post">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Codigo</label>
                                <input class="form-control" type="text" name="codigo_ong" placeholder="Codigo">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Password</label>
                                <input class="form-control" type="text" name="pass_ong" placeholder="Password">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Nombre</label>
                                <input class="form-control" type="text" name="nombre_ong" placeholder="Nombre">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mobile No</label>
                                <input class="form-control" type="text" name="tel_ong" placeholder="+123 456 789">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Direccion</label>
                                <input class="form-control" type="text" name="dir_ong" placeholder="123 Street">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>E-mail</label>
